"""
LSTM with Sampled Softmax for Product Recommendation.
...
def train():
    print("=" * 50)
    print("Training LSTM with Sampled Softmax")
    print("=" * 50)
    ...
    model.save("ml/recommendation/final/LSTM.keras")
    with open("ml/recommendation/final/LSTM.pkl", "wb") as f:
        pickle.dump({
            "p2i": product_to_idx,
            "i2p": idx_to_product,
            "u2c": u2c,
