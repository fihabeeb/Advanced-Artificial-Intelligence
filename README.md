# Advance AI Assignment

## Task 1

The proposed approach to solving task 1 problem was an LSTM model + Attention layer that focuses more or recent orders. However, during evaluation, it is found that a standard LSTM model actually performs better than the proposed architecture. 
