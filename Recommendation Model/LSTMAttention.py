"""
LSTM + Attention for Product Recommendation.
...
def train():
    ...
    if True:
        print("\nSaving...")
        model.save("ml/recommendation/final/LSTMAttentionkeras")
        with open("ml/recommendation/final/LSTMAttention.pkl", "wb") as f:
